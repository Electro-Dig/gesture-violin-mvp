...
function makeSong(melody: SongNote[], totalBeats = 48): SongDefinition {
  return {
    ...
    totalBeats,
    source: {
      url: "https://example.test/orbit-fixture.mid",
      license: "Public Domain",
      sourceFile: "orbit-fixture.mid",
      sourceTrack: 0,
      sourceBeats: [0, Math.max(totalBeats, 1)],
    ...
    arrangement: {
      ...
      transformations: ["Authored locally for orbit rhythm unit tests."],
    },
